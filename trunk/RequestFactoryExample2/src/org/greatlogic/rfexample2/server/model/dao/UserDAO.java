...
import org.greatlogic.rfexample2.server.RFEServerEnums.ERFExampleSequence;
import org.greatlogic.rfexample2.server.RFEServerEnums.ERFExampleTable;
import org.greatlogic.rfexample2.server.RFEServerEnums.UserCol;
...
public User findById(final Integer id) {
  ...
  try {
    ...
    userSQL.from(ERFExampleTable.User);
...
public Integer save(final User user) {
  ...
  try {
    GLSQL userSQL;
    if (user.getId() == 0) {
      result = ERFExampleSequence.UserId.getNextValue(1);
      userSQL = GLSQL.insert(ERFExampleTable.User, false);
      ...
      userSQL = GLSQL.update(ERFExampleTable.User);
